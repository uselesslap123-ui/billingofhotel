        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 items-start">
          <div className="lg:col-span-3 space-y-8">
             <div className="relative overflow-hidden bg-primary/10 py-2 rounded-lg -mb-4">
                <span className="animate-marquee text-lg font-semibold text-primary px-4 whitespace-nowrap">अस्सल घरगुती चवीचा खजिना. हॉटेल सुग्रण मध्ये आपले स्वागत आहे! 😋 अस्सल घरगुती चवीचा खजिना. हॉटेल सुग्रण मध्ये आपले स्वागत आहे! 😋</span>
             </div>
             <TableLayout
              tables={TOTAL_TABLES}
              activeTable={activeTable}
